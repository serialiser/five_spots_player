...
* Download the last release for your OS from here : https://github.com/serialiser/five_spots_player/releases
* Unzip
* Add a .env file in the root folder with your api keys (see below)
* **Enjoy!**
...
```
Then you can toggle on "Connect to Spotify" in the Settings screen and restart the app.
